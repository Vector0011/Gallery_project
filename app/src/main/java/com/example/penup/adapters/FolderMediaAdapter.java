...
import com.example.penup.databinding.LayoutFolderMediaItemBinding;
...
public class FolderMediaAdapter extends SelectableAdapter<FolderMediaAdapter.MediaViewHolder> {
    ...
    public FolderMediaAdapter.MediaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        LayoutFolderMediaItemBinding mediaItemBinding = LayoutFolderMediaItemBinding.inflate(layoutInflater,parent,false);
    ...
    public class MediaViewHolder extends RecyclerView.ViewHolder {
        LayoutFolderMediaItemBinding mediaItemBinding;
        public MediaViewHolder(@NonNull LayoutFolderMediaItemBinding mediaItemBinding) {
